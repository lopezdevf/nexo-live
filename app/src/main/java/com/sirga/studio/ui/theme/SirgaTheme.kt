...
package com.sirga.studio.ui.theme
...
/**
 * Identidad Sirga Studio: fondo azul noche, paneles planos con filetes finos y el azul eléctrico
...
val LocalSirgaColors = staticCompositionLocalOf { SirgaColors() }
val LocalSirgaMetrics = staticCompositionLocalOf { SirgaMetrics() }

object Sirga {
    val colors: SirgaColors @Composable get() = LocalSirgaColors.current
    val metrics: SirgaMetrics @Composable get() = LocalSirgaMetrics.current
...
@Composable
fun SirgaTheme(content: @Composable () -> Unit) {
    val c = SirgaColors()
    ...
    CompositionLocalProvider(
        LocalSirgaColors provides c,
        LocalSirgaMetrics provides SirgaMetrics(),
    ) {
