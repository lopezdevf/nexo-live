...
/**
 * Protocolo «Senda Link» v1 entre Senda Studio PC y el móvil. TCP con enteros big-endian.
 *
 * Saludo del PC: `"SNL1" · u16 código · u16 longitud + nombre del PC (UTF-8)`.
 * Respuesta del móvil: `"SNL1" · u8 resultado · u16 longitud + nombre del móvil`.
 ...
 */
object SendaLink {
    val MAGIC = byteArrayOf('S'.code.toByte(), 'N'.code.toByte(), 'L'.code.toByte(), '1'.code.toByte())
    const val DEFAULT_PORT = 9000
    const val DISCOVERY_PORT = 9750
    val DISCOVERY_QUERY = "SNL1?".toByteArray(Charsets.US_ASCII)
    val DISCOVERY_REPLY = "SNL1!".toByteArray(Charsets.US_ASCII)
    ...
    /** Lee el saludo del PC. null si no es un cliente de Senda Link. */
    ...
    /** Respuesta de descubrimiento: `"SNL1!" · u16 puerto · u16+nombre del móvil · u16+nombre de la fuente · u8 pide código`. */
