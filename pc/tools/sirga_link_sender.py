...
"""
Emisor de prueba del protocolo Sirga Link: hace de «Sirga Studio PC» sin capturar la pantalla.
...
probar la fuente PC de la app sin compilar la aplicación de Windows.
    ...
    python sirga_link_sender.py --discover
    python sirga_link_sender.py 192.168.1.10 --code 4821 --video grabacion.mp4
"""
